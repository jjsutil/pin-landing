...
I-019 (an animated "from → to" blog header — the owner has stated the mechanic, the
ES/EN word sets are his to pick), and I-020 (the blog's first post written for engineers:
OCR lessons and current state of the art, every claim cited and verified). **In review:
I-022** — a named-author persona system (starting with Founder & CEO Alicia Chang Cox)
plus an editorial calendar, so future posts in a board member's own voice stay cohesive
with the rest of the blog. Full board: [planning/BOARD.md](planning/BOARD.md) (generated
by roadmap-board — never hand-edit).
<!-- BOARD-SUMMARY:END -->
