...
E01 (blog section): I-001 (infrastructure), I-002 and I-003 (the first two posts,
owner-approved copy) all merged and staging. I-008 (third post, closing the trilogy's
argument on AI use and professional responsibility) is in-dev, shipped `draft: true`
pending owner copy approval. Owner feedback on the shipped blog (2026-08-05) opened
three more E01 issues, all backlogged: I-005 (English posts + a locale-aware
structure), I-006 (CTA/interaction on posts — comment box explicitly out unless the
owner overrides), I-007 (listing navigability — tags, timeline/topic grouping). I-004
(static mode for low-end hardware) backlogged, no epic yet. Full board:
