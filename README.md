...
OCR lessons and current state of the art, every claim cited and verified). **I-022
shipped too** — a named-author persona system (starting with Founder & CEO Alicia
Chang Cox) plus an editorial calendar, so future posts in a board member's own voice
stay cohesive with the rest of the blog. **I-023 shipped too** — the blog's first
named-founder post, "Why I started pin" / "Por qué empecé pin", Alicia's own account
of why pin exists, live at `/blog/`. Full board: [planning/BOARD.md](planning/BOARD.md) (generated by
