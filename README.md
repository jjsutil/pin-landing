...
E01 (blog section) is fully staging: the content trilogy-plus-three (I-001–I-003,
I-008, I-010), the CTA/tag-filter polish (I-006, I-007), and the structural i18n pass
(I-011 — condensed listing + English blog) all shipped. I-005 (English posts, filed
before I-011) is staging too, closed as superseded — I-011 delivered its full scope.
I-009 (logo not navigating home) shipped, staging. In review: I-004 (static mode for
low-end hardware — the header's backdrop-filter cost already shipped standalone; this
adds the FPS self-benchmark + `perf-lite` class, PR pending). Backlog: I-012 (blog
pagination doesn't scale past ~20 posts, dot-styled `paginate()` once scheduled), I-013
(a scroll-driven vertical timeline view for the blog, validated through a shared design
Artifact — next up for implementation), I-014 (pinned/featured post ordering), and
I-015 (a spike on view-count tracking — no backend today, so this decides how before
anything gets built). Full board: [planning/BOARD.md](planning/BOARD.md) (generated by
