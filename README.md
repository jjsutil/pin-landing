...
owner-approved copy) all merged and staging. I-004 (static mode for low-end hardware)
backlogged, no epic yet. Full board: [planning/BOARD.md](planning/BOARD.md)
