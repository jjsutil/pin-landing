...
I-018 (a doc note claiming CI is blocked by billing, false for this public repo), and
I-019 (an owner request for an animated "from → to" blog header whose scope was never
written down — it needs one line from the owner before it can be planned). Full board: [planning/BOARD.md](planning/BOARD.md) (generated by
