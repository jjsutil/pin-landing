...
owner-approved copy) all merged and staging. Owner feedback on the shipped blog
(2026-08-05) opened three more E01 issues, all backlogged: I-005 (English posts + a
locale-aware structure), I-006 (CTA/interaction on posts — comment box explicitly
out unless the owner overrides), I-007 (listing navigability — tags, timeline/topic
grouping). I-004 (static mode for low-end hardware) backlogged, no epic yet. Full
board: [planning/BOARD.md](planning/BOARD.md) (generated by roadmap-board — never
hand-edit).
<!-- BOARD-SUMMARY:END -->
