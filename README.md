...
drafted by a dispatched Fable-model agent, live at `/blog/`. **In review: I-026** —
the timeline frame now stays full at both ends (~6 posts, always) and the scroll
rests in discrete steps; it reverses I-021, whose padding *was* the empty half-frame,
and re-accepts by owner decision that the first and last post no longer reach focus.
